  ...
  return (
    ...
    initial={{
       ...
       className="flex flex-col py-16 mb-5 mx-5 sm:mx-20 sm:px-12">
        <h1 className=" mb-5 font-custom text-4xl text-center">Summary Background</h1>
        <div className="flex flex-col sm:flex-row sm:space-x-10 ">
            <div className="flex justify-center mb-7">
            <img src="/SummaryBackground.jpg" alt="KMF Background" className="rounded-lg shadow-lg" />
            </div>
