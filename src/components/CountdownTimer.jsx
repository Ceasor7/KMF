...
const CountdownTimer = ({ targetDate }) => {
  ...
  return (
    <div className="flex items-center justify-center space-x-2">
      ...
      <div className="text-base sm:text-lg font-custom">Months</div>
        <div className="font-bold text-4xl font-custom">{timeLeft.months}</div>
      </div>
      <div className="text-center">
      <div className="text-base sm:text-lg font-custom">Days</div>
        <div className="font-bold text-4xl font-custom">{":"}{timeLeft.days}</div>
      </div> 
      <div className="text-center">
      <div className="text-base sm:text-lg font-custom">Hours</div>
        <div className="font-bold text-4xl font-custom">{":"}{timeLeft.hours}</div>
      </div>
      <div className="text-center">
      <div className="text-base sm:text-lg font-custom">Minutes</div>
        <div className="font-bold text-4xl font-custom">{":"}{timeLeft.minutes}</div>
      </div>
      <div className="text-center">
      <div className="text-base sm:text-lg font-custom">Seconds</div>
